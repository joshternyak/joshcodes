...
* In some cases Bash returns true if the given string "contains" the pattern, whereas that library returns true if the string is an exact match for the pattern. You can relax that by setting `options.contains` to true.
