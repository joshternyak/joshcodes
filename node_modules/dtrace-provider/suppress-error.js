 ...
 *
 * (Note that that expression is written to work on *nix and Windows.)
 *
 ...
 * handle that scenario, so users on those systems will need to either install
