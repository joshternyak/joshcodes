...
=&gt; []
      ...
      <p id="bind">
        ...
        the function is called, the value of <i>that</i> will be the <b>object</b>.
        Optionally, bind <b>arguments</b> to the <b>function</b> to pre-fill them,
        also known as <b>partial application</b>.
      </p>
      <pre>
var func = function(greeting){ return greeting + ': ' + that.name };
...
=&gt; 'hi: moe'
      ...
      <p id="bindAll">
        ...
        <i>that</i>. If no <b>methodNames</b> are provided, all of the object's
        function properties will be bound to it.
      </p>
      <pre>
var buttonView = {
  label   : 'underscore',
  onClick : function(){ alert('clicked: ' + that.label); },
  onHover : function(){ console.log('hovering: ' + that.label); }
};
_.bindAll(buttonView);
jQuery('#underscore_button').bind('click', buttonView.onClick);
=&gt; When the button is clicked, that.label will have the correct value...
</pre>
...
=&gt; [["one", 1], ["two", 2], ["three", 3]]
      ...
      <p id="invert">
        ...
        and the values the keys. For that to work, all of your object's values 
...
=&gt; {name : 'moe'};
      ...
      <p id="tap">
        ...
        The primary purpose of that method is to "tap into" a method chain, in order to perform operations on intermediate results within the chain.
      </p>
      <pre>
_.chain([1,2,3,200])
...
=&gt; true
      ...
      <p id="isNaN">
        ...
        <br />
        Returns <i>true</i> if <b>object</b> is <i>NaN</i>.<br /> Note: that is not
...
=&gt; {lumberjack : 2, all : 4, night : 2 ... }</pre>
      ...
      <p id="chain">
        ...
        <br />
        Returns a wrapped object. Calling methods on that object will continue
...
=&gt; [1, 2, 3]
      ...
      <p>
        ...
        <ul>
          <li>
            ...
            so you can use the value of <tt>that</tt> if you like.
          </li>
          <li>
      ...
      <p>
        ...
        as a value. <tt>_.wrap</tt> now correctly sets <tt>that</tt> for the
      ...
      <p>
        ...
        each implementation &mdash; that removes the try/catch, and you'll now have
