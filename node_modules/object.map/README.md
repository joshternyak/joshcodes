...
> Similar to map for arrays, that creates a new object by calling the callback on each property of the original object.
...
Optionally specify a `thatArg` as the last argument:
