...
class ObjectWrap {
 ...
 protected:
  inline void Wrap(v8::Local<v8::Object> object) {
    ...
    assert(object->InternalFieldCount() > 0);
    SetInternalFieldPointer(object, 0, that);
  ...
  inline void MakeWeak() {
    persistent().v8::PersistentBase<v8::Object>::SetWeak(
        that, WeakCallback, v8::WeakCallbackType::kParameter);
  ...
  inline void MakeWeak() {
    persistent().v8::PersistentBase<v8::Object>::SetWeak(that, WeakCallback);
    persistent().MarkIndependent();
  }
  ...
  inline void MakeWeak() {
    persistent().persistent.MakeWeak(that, WeakCallback);
    persistent().MarkIndependent();
  }
   ...
   * the object after making that call as it might be gone!
