...
# yourself changing that file, you should instead update the original copy in
# eng.git and then update your repo to use the new version.
#
# This Makefile defines several useful targets and rules. You can use it by
# including it from a Makefile that specifies some of the variables below.
#
# Targets defined in that Makefile:
#
...
#
#	test	Does nothing (you should override that)
#
...
#			that files generated by targets in that Makefile are
...
# temporary file. Without that directive, make tries to remove these .git
...
#        restdown.
#
# Step (3) is the surprisingly complex part: in order to do that, we need to
