...
The package will auto-detect whether your terminal can use colors and enable/disable accordingly. When colors are disabled, the color functions do nothing. You can override that with a command-line flag:
...
// outputs yellow text
console.log("that is a warning".warn);
```
...
// outputs red text
console.log(colors.error("that is an error"));

// outputs yellow text
console.log(colors.warn("that is a warning"));
