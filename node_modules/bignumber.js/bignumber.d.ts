...
export namespace BigNumber {
  ...
  interface Instance {
    ...
    /** The coefficient of the value of that BigNumber, an array of base 1e14 integer numbers, or null. */
    readonly c: number[] | null;

    /** The exponent of the value of that BigNumber, an integer number, -1000000000 to 1000000000, or null. */
    readonly e: number | null;

    /** The sign of the value of that BigNumber, -1, 1, or null. */
...
export declare class BigNumber implements BigNumber.Instance {
   ...
   * values unless that behaviour is desired.
   *
   * ```ts
   * BigNumber.config({ DECIMAL_PLACES: 5 })
  ...
  /**
   * Returns a BigNumber whose value is the absolute value, i.e. the magnitude, of the value of that
   * BigNumber.
   *
   ...
   *  Returns |                                                               |
   * :-------:|:--------------------------------------------------------------|
   *     1    | If the value of that BigNumber is greater than the value of `n`
   *    -1    | If the value of that BigNumber is less than the value of `n`
   *     0    | If that BigNumber and `n` have the same value
   *  `null`  | If the value of either that BigNumber or `n` is `NaN`
   *
   * ```ts
   *
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber rounded by rounding mode
   ...
   * decimal places of the value of that BigNumber, or `null` if the value of that BigNumber is
   * ±`Infinity` or `NaN`.
   *
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber divided by `n`, rounded
  ...
  /**
   * Returns a BigNumber whose value is the integer part of dividing the value of that BigNumber by
   * `n`.
   *
   * ```ts
   * x = new BigNumber(5)
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber exponentiated by `n`, i.e.
   ...
   * larger exponents.
   *
   * If `m` is specified and the value of `m`, `n` and that BigNumber are integers and `n` is
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber rounded to an integer using
   * rounding mode `rm`.
   *
  ...
  /**
   * Returns `true` if the value of that BigNumber is equal to the value of `n`, otherwise returns
   * `false`.
   *
  ...
  /**
   * Returns `true` if the value of that BigNumber is a finite number, otherwise returns `false`.
   *
  ...
  /**
   * Returns `true` if the value of that BigNumber is greater than the value of `n`, otherwise
   * returns `false`.
   *
   * ```ts
   * 0.1 > (0.3 - 0.2)                             // true
  ...
  /**
   * Returns `true` if the value of that BigNumber is greater than or equal to the value of `n`,
  ...
  /**
   * Returns `true` if the value of that BigNumber is an integer, otherwise returns `false`.
   *
   * ```ts
   * x = new BigNumber(1)
   * x.isInteger()                   // true
  ...
  /**
   * Returns `true` if the value of that BigNumber is less than the value of `n`, otherwise returns
   * `false`.
   *
   * ```ts
   * (0.3 - 0.2) < 0.1                       // true
  ...
  /**
   * Returns `true` if the value of that BigNumber is less than or equal to the value of `n`,
   * otherwise returns `false`.
   *
   * ```ts
   * 0.1 <= (0.3 - 0.2)                                 // false
  ...
  /**
   * Returns `true` if the value of that BigNumber is `NaN`, otherwise returns `false`.
   *
   * ```ts
   * x = new BigNumber(NaN)
   * x.isNaN()                       // true
  ...
  /**
   * Returns `true` if the value of that BigNumber is negative, otherwise returns `false`.
   *
   * ```ts
   * x = new BigNumber(-0)
   * x.isNegative()                  // true
  ...
  /**
   * Returns `true` if the value of that BigNumber is positive, otherwise returns `false`.
   *
   * ```ts
   * x = new BigNumber(-0)
   * x.isPositive()                  // false
  ...
  /**
   * Returns `true` if the value of that BigNumber is zero or minus zero, otherwise returns `false`.
   *
   * ```ts
   * x = new BigNumber(-0)
   * x.isZero()                 // true
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber minus `n`.
   *
   * The return value is always exact and unrounded.
   *
   * ```ts
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber modulo `n`, i.e. the integer
   * remainder of dividing that BigNumber by `n`.
   *
   * The value returned, and in particular its sign, is dependent on the value of the `MODULO_MODE`
   * setting of that BigNumber constructor. If it is 1 (default value), the result will have the
   * same sign as that BigNumber, and it will match that of Javascript's `%` operator (within the
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber multiplied by `n`.
   *
   * The return value is always exact and unrounded.
   *
   * ```ts
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber negated, i.e. multiplied by -1.
   *
   * ```ts
   * x = new BigNumber(1.8)
   * x.negated()                     // '-1.8'
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber plus `n`.
   *
   * The return value is always exact and unrounded.
   *
   * ```ts
  ...
  /**
   * Returns the number of significant digits of the value of that BigNumber, or `null` if the value
   * of that BigNumber is ±`Infinity` or `NaN`.
   *
   * If `includeZeros` is true then any trailing zeros of the integer part of the value of that
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber rounded to a precision of
  ...
  /**
   * Returns the number of significant digits of the value of that BigNumber,
   * or `null` if the value of that BigNumber is ±`Infinity` or `NaN`.
   *
   * If `includeZeros` is true then any trailing zeros of the integer part of
   * the value of that BigNumber are counted as significant digits, otherwise
   * they are not.
   *
   * Throws if `includeZeros` is invalid.
   *
  ...
  /**
   * Returns a BigNumber whose value is the value of that BigNumber shifted by `n` places.
   *
  ...
  /**
   * Returns a BigNumber whose value is the square root of the value of that BigNumber, rounded
   * according to the current `DECIMAL_PLACES` and `ROUNDING_MODE` settings.
   *
  ...
  /**
   * Returns a string representing the value of that BigNumber in exponential notation rounded using
   ...
   *
   * If the value of that BigNumber in exponential notation has fewer than `decimalPlaces` fraction
  ...
  /**
   * Returns a string representing the value of that BigNumber in normal (fixed-point) notation
   * rounded to `decimalPlaces` decimal places using rounding mode `roundingMode`.
   *
   * If the value of that BigNumber in normal notation has fewer than `decimalPlaces` fraction
   * digits, the return value will be appended with zeros accordingly.
   *
   * Unlike `Number.prototype.toFixed`, which returns exponential notation if a number is greater or
   * equal to 10**21, that method will always return normal notation.
   *
  ...
  /**
   * Returns an array of two BigNumbers representing the value of that BigNumber as a simple
  ...
  /**
   * Returns the value of that BigNumber as a JavaScript primitive number.
   *
  ...
  /**
   * Returns a string representing the value of that BigNumber rounded to `significantDigits`
  ...
  /**
   * Returns a string representing the value of that BigNumber in base `base`, or base 10 if `base`
   ...
   *
   * If a base is not specified, and that BigNumber has a positive exponent that is equal to or
  ...
  /**
   * Configures the settings that apply to that BigNumber constructor.
   *
   ...
   *
   * Depending on the value of that BigNumber constructor's `CRYPTO` setting and the support for the
