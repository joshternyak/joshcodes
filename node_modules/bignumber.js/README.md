...
It also does not allow `NaN` or `Infinity`, or have the configuration options of that library.
...
BigNumbers can be created from values in bases from 2 to 36. See [`ALPHABET`](http://mikemcl.github.io/bignumber.js/#alphabet) to extend that range.
