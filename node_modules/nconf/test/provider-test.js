        ...
        "without a callback": {
          "given an array of keys with one matching": {
            "should respond with the correct value": function (provider) {
              assert.equal(provider.any(["notthat", "orthat", "key"]), 'getThisValue');
            }
          },
          "given an array of keys with no match": {
            "should respond with null": function (provider) {
              assert.isNull(provider.any(["notthat", "orthat"]));
            }
          },
        ...
        "with a callback": {
          "given an array of keys with one matching": {
            topic: function(provider) {
              provider.any(["notthat", "orthat", "key"], that.callback);
            },
          ...
          "given an array of keys with no match": {
            topic: function(provider) {
              provider.any(["notthat", "orthat"], that.callback);
            },
