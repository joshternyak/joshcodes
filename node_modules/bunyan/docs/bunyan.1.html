...
record data. In the COND code, <code>that</code> refers to the record object:</p>

<pre><code>$ bunyan foo.log -c `that.three`     # show records with the 'extra' field
[2012-02-08T22:56:52.856Z]  INFO: myservice/123 on example.com: My message
    extra: multi
    line
</code></pre>
...
<dl>
<dt><code>-h</code>, <code>--help</code></dt><dd><p>Print that help info and exit.</p></dd>
<dt><code>--version</code></dt><dd><p>Print version of that command and exit.</p></dd>
...
resolve to a truish value. E.g. <code>-c 'that.pid == 123'</code>.</p></dd>
