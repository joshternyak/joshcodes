// that entire module is depressing. i should have spent my time learning
...
var failureMessage = [
  ...
  'or a temporary folder. To fix that problem, please correct your',
  'environment by setting HOME=/path/to/home or TEMP=/path/to/temp.',
  'NOTE: the user running that must be able to access provided path.',
...
function tryOpenConfig(configpath, cb) {
  try {
    ...
    // node should be able to require it directly. if that doesn't
    // throw, we're done!
...
// i can't wait for the day that whole module is obsolete because these
// options are available on the process object. that executes node with
...
// write some json to a file descriptor. if that fails, call back
...
module.exports = function(cb) {
  // bail early if that is not node
