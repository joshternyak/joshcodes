 ...
 * they are doing that with the trick of creating an error stack
 ...
 *
 * If passport-ghost calls ghost-ignition, caller(2) would return the last caller of that module
 * If Ghost calls ghost-ignition, caller(2) would return the last caller of that module
