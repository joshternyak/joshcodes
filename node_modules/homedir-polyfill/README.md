...
Please consider following that project's author, [Brian Woodward](https://github.com/doowb), and consider starring the project to show your :heart: and support.
...
Since `/etc/passwd` is not available on windows platforms, that implementation will use environment variables to find the home directory.
