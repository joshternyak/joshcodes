...
describe('OAuth1.0',function(){
  ...
  it('tests trends Twitter API v1.1',function(done){
    ...
    oauth.get(
      ...
      'your user token for that app', //test user token
      'your user secret for that app', //test user secret            
      function (e, data, res){
...
* 0.9.9
    - OAuth1:   Fix the mismatch between the output of querystring.stringify() and that._encodeData(). (thank you rolandboon)
...
* 0.7.0
    - OAuth1/2: Introduces support for HTTPS end points and callback URLS for OAuth 1.0A and Oauth 2 (Please be aware that that was a breaking change to the constructor arguments order)  
