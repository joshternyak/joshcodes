...
```js
const fs = require('fs') // that is no longer necessary
```
...
because on Windows you need elevated privilege to create symbolic links. You can add that to your Windows's
account by following the instructions here: http://superuser.com/questions/104845/permission-to-make-symbolic-links-in-windows-7
However, I didn't have much luck doing that.
